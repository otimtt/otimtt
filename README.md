...
|---------|-------|-----------|
| [**RepairOS**](https://github.com/otimtt/RepairOS) | PHP · SQLite · MySQL | Sistema completo para lojas de conserto de eletrônicos — OS, clientes, estoque, financeiro e painel personalizável |
| [**SysPanel**](https://github.com/otimtt/SysPanel) | FastAPI · WebSocket · JS | Dashboard de monitoramento do sistema Linux em tempo real — CPU, RAM, disco, temperatura e processos |
| [**FinanceControl**](https://github.com/otimtt/FinanceControl) | HTML · CSS · JS | Gestão de finanças pessoais com categorias, limites de orçamento e gráficos |
| [**AgendaFácil**](https://github.com/otimtt/AgendaFacil) | HTML · CSS · JS | Sistema de agendamento para salões e clínicas com calendário visual e histórico de clientes |
| [**EstoqueSimples**](https://github.com/otimtt/EstoqueSimples) | HTML · CSS · JS | Controle de estoque para pequenos negócios com alertas de mínimo e histórico de movimentações |
...
| Projeto | Stack | Descrição |
|---------|-------|-----------|
| [**WallpaperRS**](https://github.com/otimtt/WallpaperRS) | Rust · WGPU · egui | Motor de wallpapers animados de alta performance com renderização acelerada por GPU |
...
| Projeto | Descrição |
|---------|-----------|
| [**VulnScan**](https://github.com/otimtt/VulnScan) | Scanner automatizado de vulnerabilidades web — XSS, SQLi, redirecionamentos e headers ausentes |
| [**NetRecon**](https://github.com/otimtt/NetRecon) | Scanner de portas multi-thread com captura de banners e fingerprinting de SO |
| [**LogHunter**](https://github.com/otimtt/LogHunter) | Analisador de logs estilo SIEM — detecta força bruta e ataques em logs Apache/Nginx e SSH |
| [**CryptoVault**](https://github.com/otimtt/CryptoVault) | Gerenciador de senhas local com criptografia AES-256-GCM e limpeza automática de clipboard |
| [**CTFPlatform**](https://github.com/otimtt/CTFPlatform) | Plataforma completa para CTF com auth JWT, placar ao vivo e API admin |
